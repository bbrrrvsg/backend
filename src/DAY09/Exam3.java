...
public class Exam3 {
    public static void main(String[] args) {
        ...
        obj2.show(); // 부모메소드 대신에 오버라이딩된 메소드
        obj2.show2();

        //(3) 타입변환 // 자식 -> 부모 타입변환
        상위클래스 obj3 = obj2;
        obj3.show(); // 부모 와자식 간 메소드가 동일하면 오버라이딩 우선

        //(4) 부모와 자식 간의 멤버변수간의 공유가능
...
class 하위클래스 extends 상위클래스{
    ...
    void show(){ // 상위클래스 메소드 선언부가 일치하면 오버라이딩
        ...
        System.out.println("하위클래스 메소드 재정의 ");
    }
    ...
    void show2(){
        ...
        System.out.println(super.value); // super : 상위 객체 뜻
        // 부모와 자식간의 멤버변수명이 동일할때 this ,super 사용한 구분 한다.
