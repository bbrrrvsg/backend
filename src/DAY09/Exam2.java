    ...
    public static void main(String[] args) {
      ...
      //   C c2 = (C)a2; // 오류발생 , a2의 태생은 b객체 이므로 b가 태어날때 c는 생성되지 않았다.
        ...
        System.out.println(a instanceof Object);
            // a 객체가 생성될떄 Object가 생성되었는지 확인
        // System.out.println(b instanceof C); // false
            // b 객체가 생성될떄 C가 생성되었는지 확인
        System.out.println(e instanceof A); // ture
        System.out.println(b instanceof D); // false
            //b객체가 생성될떄 D가 생성되었는지 확인

        // 즉] 해당 객체가 생성될대 부모객체는 생성되지만 자식객체는 생성 안된다.
        // *다운캐스팅이 안되는 전제조건*
