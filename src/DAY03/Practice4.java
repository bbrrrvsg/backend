...
출력 예시: 더 큰 수: 25 */
        ...
        if(n3 < n4 ){
            System.out.println("더 큰수 :"+n4);
        }
        else if(n4 < n3){
            System.out.println("더 큰수 :"+n3);
        }
...
출력 예시: 여자 */
        ...
        System.out.print("주민등록번호(-포함) 13자리를 입력하세요: 950101-2******");String junum = sc.next();

        if(junum.charAt(7)=='1'||junum.charAt(7)=='3'){
...
출력 예시: B등급 */
        ...
        System.out.print("점수를 입력하세요: "); int sco1 = sc.nextInt();
...
출력 예시: 최종 결제 금액: 54000원 */
        System.out.print("총 구매 금액: "); int pri = sc.nextInt();
